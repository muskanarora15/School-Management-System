...
public class Dept extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Maths", "Physics", "Chemistry",
                "Biology", "Accounts", "B.S. ", "I.P.", "C.S.", "English", "Economics", "Hindi", "Sanskrit", "French",
                "Science", "History", "Political Science", "Geography", "Music ", "Dance", "Arts", "E.ship", " " }));
