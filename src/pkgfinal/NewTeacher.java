...
public class NewTeacher extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(
                javax.swing.BorderFactory.createMatteBorder(2, 2, 2, 2, new java.awt.Color(0, 0, 0)), "Records",
                javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION,
                new java.awt.Font("Monotype Corsiva", 3, 24))); // NOI18N
        ...
        jComboBox4.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "January", "February", "March",
        ...
        jComboBox5.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "1956",
                "1957", "1958", "1959", "1960",
                "1961", "1960", "1962", "19603", "1964", "1965", "1966", "1967", "1968",
                "1969", "1970", "1971", "1972",
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Physics", "Chemistry", "Maths",
                "Biology", "I.P.", "C.S.", "English", "Hindi", "French", "Sanskrit", "Economics", "B.S.", "Accounts",
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton6ActionPerformed
        ...
        if (tid.isEmpty()) {
            ...
            try {
                ...
                String check = "Select * from teacher1 where Tid = '" + tid + "'";

                ResultSet rs = stmt.executeQuery(check);

                if (rs.next()) {
                    JOptionPane.showMessageDialog(this,
                            "Teacher ID already exists" + "\n" + "Please Enter another Teacher ID", "Error",
                            JOptionPane.ERROR_MESSAGE);
                    Tid.setText("");
                } else {
                    if (nm.isEmpty() || cno.isEmpty() || add.isEmpty() || sal.isEmpty()) {
                        JOptionPane.showMessageDialog(this, "Please fill all the entries", "Error",
                                JOptionPane.ERROR_MESSAGE);
                    } else {
                        String query = "insert into teacher1 values('" + tid + "','" + nm + "','" + dept + "','" + dob
                                + "','" + cno + "','" + add + "','" + post + "','" + sal + "')";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewTeacher.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
        }
        // </editor-fold>
        // </editor-fold>
