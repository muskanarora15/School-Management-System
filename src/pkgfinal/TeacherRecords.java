...
public class TeacherRecords extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Records",
        ...
        ydob.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "1956", "1957", "1958", "1959", "1960",
                "1961", "1960", "1962", "19603", "1964", "1965", "1966", "1967", "1968", "1969", "1970", "1971", "1972",
        ...
        Dept.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Physics", "Chemistry", "Maths", "Biology",
                "I.P.", "C.S.", "English", "Hindi", "French", "Sanskrit", "Economics", "B.S.", "Accounts", "Psychology",
                "History", "Political Science", "Geography", "P.E.", "Arts", "Music", "Dance", " " }));
        jPanel1.add(Dept);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (tid.isEmpty()) {
            ...
            try {
                 ...
                 * 
                 * Connection con =
                 * DriverManager.getConnection("jdbc:mysql://localhost:3306/schooladmin",
                 * "root",
                 * "mysql");
                 */
        ...
        if (tid.isEmpty()) {
            ...
            if (nm.isEmpty() || cno.isEmpty() || add.isEmpty() || sal.isEmpty()) {
                ...
                try {
                    ...
                    String query = "Update Teacher1 set Name = '" + nm + "',Dept ='" + dept + "',DOB ='" + dob
                            + "',Cno ='" + cno + "', Address ='" + add + "',Position ='" + post + "',Salary ='" + sal
                            + "' where Tid ='" + tid + "'";
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    if (confirm == JOptionPane.YES_OPTION) {
                        ...
                        JOptionPane.showMessageDialog(this, "Successfully Deleted", "Delete",
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TeacherRecords.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
        }
        // </editor-fold>
        // </editor-fold>
