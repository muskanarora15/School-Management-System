...
public class NewStudent extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(
                ...
                new java.awt.Font("Monotype Corsiva", 3, 36))); // NOI18N
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "January", "February", "March",
        ...
        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel<>(
                new String[] { "1996", "1997", "1998", "1999", "2000", "2001", "2002", "2003", "2004", "2005",
        ...
        jComboBox6.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "2003", "2004", "2005", "2006",
        ...
        jComboBox7.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Nursery", "LKG", "UKG", "I", "II",
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            try {
                ...
                if (!rs.next()) {
                    if (nm.isEmpty() || fnm.isEmpty() || mnm.isEmpty() || cno.isEmpty() || add.isEmpty()) {
                        ...
                        String query = "insert into StdRec values (" + sno + ",'" + nm + "','" + fnm + "','" + mnm
                                + "','" + dob + "','" + cno + "','" + add + "','" + doa + "','" + cla + "')";
                    ...
                    JOptionPane.showMessageDialog(this,
                            "Scholar Number already exists" + "\n" + "Please Enter another Scholar Number", "Error",
                            JOptionPane.ERROR_MESSAGE);
                    schno.setText("");
                }
            ...
            JOptionPane.showMessageDialog(this, "Please enter a valid Scholar Number");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewStudent.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
