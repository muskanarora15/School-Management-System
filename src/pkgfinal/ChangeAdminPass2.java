...
public class ChangeAdminPass2 extends javax.swing.JFrame {
            ...
            try {
                ...
                if (rs.next()) {
                    if (npass.equals(rnpass)) {
                        ...
                        JOptionPane.showMessageDialog(this, "Password did not match", "Error",
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChangeAdminPass2.class.getName()).log(java.util.logging.Level.SEVERE,
                    null, ex);
